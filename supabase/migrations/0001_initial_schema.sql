...
create table public.accounts (
  ...
  portfolio_id uuid not null references public.portfolios(id) on delete cascade,
  name text not null,
  type text not null check (type in ('cash', 'bank', 'card', 'savings', 'investment', 'crypto', 'debt', 'custom')),
...
create table public.transactions (
  ...
  source text not null default 'manual' check (source in ('manual', 'text_ai', 'receipt_ai', 'recurring')),
