...
export function DebtPage({ currencyMode, ratesVersion }: { currencyMode: DisplayCurrency; ratesVersion: number }) {
  ...
  const projections = useMemo(() => {
    void ratesVersion;
    return state.debts.map((debt) => ({ debt, projection: buildDebtProjection(debt, state.events) }));
