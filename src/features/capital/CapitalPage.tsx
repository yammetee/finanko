...
export function CapitalPage({ onBack }: Props) {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (editor === "item") {
        const item = { groupId, name, symbol: symbol || undefined, type: itemType, quoteCurrency: currency, manualPrice: price || (itemType === "cash" || itemType === "deposit" ? "1" : undefined), primaryProvider: provider, primaryAssetId: providerAssetId || undefined, fallbackProvider, fallbackAssetId: fallbackAssetId || undefined, annualInterestRate: interestRate || undefined, interestCadence: interestRate ? interestCadence : undefined, interestEffectiveFrom: interestRate ? interestFrom : undefined, interestCompounding: interestRate ? interestCompounding : false, incomeDestinationItemId: interestRate && !interestCompounding ? incomeDestination || undefined : undefined, defaultTaxRate: interestRate ? defaultTaxRate || undefined : undefined };
